...
function Cards({filteredcards,cards}){
    ...
    {mappedcard}
        ...
        const mappedcards = cards.map(card=>{<Card key={card.id} title={card.title} date={card.title} explanation={card.explanation} copyright={card.copyright} media_type={card.media_type} url={card.url} hd_url={card.hd_url} />})
